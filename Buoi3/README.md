...
<body>
  ...
  <img src="./Anh.png"  width="100" height="140">
  <div class="iteam1">HEE</div>
  <div class="iteam2">HWHW</div>
...
![alt text](AnhBuoi3/Anh7.png)

### Overflow

+ Thuộc tính này overflowchỉ định liệu có nên cắt nội dung hay thêm thanh cuộn khi nội dung của một phần tử quá lớn không vừa với vùng đã chỉ định.

+ Thuộc tính này overflowcó các giá trị sau:

+ visible- Mặc định. Phần tràn không bị cắt. Nội dung hiển thị bên ngoài hộp của phần tử.
+ hidden- Phần tràn sẽ được cắt bớt và phần nội dung còn lại sẽ ẩn đi
+ scroll- Phần tràn được cắt bớt và thêm thanh cuộn để xem phần còn lại của nội dung
...
Ví dụ:
Nếu cửa sổ trình duyệt có kích thước 1200px hoặc nhỏ hơn, màu nền sẽ là màu xanh lam nhạt:
...
![alt text](AnhBuoi3/Anh8.png)

Thành như thế này:

![alt text](AnhBuoi3/Anh9.png)
## CSS Dropdowns
...
Giao diện của biểu mẫu HTML có thể được cãi thiện đáng kể bằng CSS
...
<head>
  ...
  <style>
    ...
    input[type=submit]{
      ...
      padding: 10px;
      display: block;
      background-color: rgb(24, 212, 106);
      margin: 8px 0px;
      border: none;
      border-radius: 4px;
      cursor: pointer;
...
![alt text](AnhBuoi3/Anh10.png)

Thuộc tính width
+ Sử dụng widththuộc tính này để xác định chiều rộng của trường nhập liệu:
Padded Inputs
+ Sử dụng paddingthuộc tính này để thêm khoảng trắng vào trường văn bản.
Bordered Inputs
+ Sử dụng borderthuộc tính này để thay đổi kích thước và màu đường viền, và sử dụng border-radius thuộc tính này để thêm các góc bo tròn
+ Nếu bạn chỉ muốn có đường viền phía dưới, hãy sử dụng border-bottomthuộc tính
